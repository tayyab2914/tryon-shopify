...
Order-conversion tracking (added 2026-05-22, user chose this over a Web Pixel) uses the **`orders/create` webhook** + the **`read_orders`** scope (scopes are now `read_products,read_orders` in `shopify.app.toml`).
